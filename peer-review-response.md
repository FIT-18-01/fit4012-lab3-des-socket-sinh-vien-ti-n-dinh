...
******** (TV2): Phần `sender.py` của Kiên làm tốt, đóng gói packet chuẩn. Nhưng ở hàm `get_message()`, nếu người dùng không nhập gì mà nhấn Enter luôn, hệ thống vẫn tạo ra một ciphertext rỗng (chỉ có byte padding). Nên thêm logic bắt buộc người dùng nhập ít nhất 1 ký tự.
